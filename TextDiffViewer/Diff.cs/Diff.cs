namespace my.utils
{
    ...
    public static string TestHelper(Item []f) {
      ...
      return (ret.ToString());
        ...
        {
            return (DiffText(TextA, TextB, false, false, false, false));
        } // DiffText
        ...
        /// <param name="wordWise">When set to true, text is splitted with occurence of space. Diff item are created for words (not for a new line of text) Added by Prabesh KC (Nepasoft solutions pvt. ltd.)</param>
        /// <returns>Returns a array of Items that describe the differences.</returns>
        public static Item[] DiffText(string TextA, string TextB, bool trimSpace, bool ignoreSpace, bool ignoreCase, bool wordWise)
        {
            // prepare the input-text and convert to comparable numbers.
            Hashtable h = new Hashtable(TextA.Length + TextB.Length);

            // The A-Version of the data (original data) to be compared.
            DiffData DataA = new DiffData(DiffCodes(TextA, h, trimSpace, ignoreSpace, ignoreCase, wordWise));

            // The B-Version of the data (modified data) to be compared.
            DiffData DataB = new DiffData(DiffCodes(TextB, h, trimSpace, ignoreSpace, ignoreCase, wordWise));
        ...
        /// <param name="wordWise">When set to true, text is splitted with occurence of space (not for occurence of new line) Added by Prabesh KC (Nepasoft solutions pvt. ltd.)</param>
        /// <returns>a array of integers.</returns>
        private static int[] DiffCodes(string aText, Hashtable h, bool trimSpace, bool ignoreSpace, bool ignoreCase, bool wordWise)
        {
